...
import {
  require_base64_js
} from "./chunk-ZQ7LHHXE.js";
import {
  __toESM
} from "./chunk-5WRI5ZAA.js";

// node_modules/spacetimedb/dist/react/index.mjs
...
var SpacetimeDBContext = (0, import_react.createContext)(
  void 0
);
function useSpacetimeDB() {
  const context = (0, import_react.useContext)(SpacetimeDBContext);
  if (!context) {
    throw new Error(
...
function SpacetimeDBProvider({
  ...
  const fallbackStateRef = React.useRef({
    isActive: false,
    identity: void 0,
    token: void 0,
    connectionId: ConnectionId.random(),
  ...
  const subscribe = React.useCallback(
    (onStoreChange) => ConnectionManager.subscribe(key, onStoreChange),
    [key]
  );
...
function useTable(query, callbacks) {
  ...
  const [subscribeApplied, setSubscribeApplied] = (0, import_react.useState)(false);
  let connectionState;
  try {
  ...
  const latestTransactionEventId = (0, import_react.useRef)(null);
  const lastSnapshotRef = (0, import_react.useRef)(null);
  const computeSnapshot = (0, import_react.useCallback)(() => {
    if (!enabled) {
      return [[], true];
    }
...
//# sourceMappingURL=spacetimedb_react.js.map
